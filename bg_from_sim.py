...
class solar_model_from_sim(solar_model):
	...
	"""
	def __init__(self, filename=None, datadict=None):
		if filename is not None:
			#Generated by cls.save
			with open(filename, 'rb') as f:
				d = pickle.load(f)
		elif datadict is not None:
			#Generated by cls.save_class
			d = datadict
		else:
			raise ValueError("Specify either pickle file or data dictionary")
	...
	@classmethod
	def save_class(cls, savefile, simdir="."):
		import pencil as pc
